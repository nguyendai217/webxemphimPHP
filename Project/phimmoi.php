...
$sql = "select * from phim ORDER by id_phim desc limit $offset,$limit";
...
<div class="main">
  <div class="main-left">
    <div class="group-phim">
      <div class="imgheader">
        <h5 style="margin: 5px 5px 5px 5px  ;"> <i class="fa fa-film" aria-hidden="true"></i> PHIM MỚI</h5>
      </div>
